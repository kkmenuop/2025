...
local L_33_ = loadstring(game:HttpGet("https://raw.githubusercontent.com/xHeptc/Kavo-UI-Library/main/source.lua"))()
local L_34_ = L_33_:Window("KakahMenu  Equipe Kakah Menu", Enum.KeyCode.LeftControl)
print("|Kakah Menu DEBUG| Anti AFK")
game:GetService("Players").LocalPlayer.Idled:connect(function()
	print("|KakahMenu DEBUG| AFK detected, prevented +1")
...
spawn(function()
	print("|KakahMenu DEBUG| Anti Stranger Join")
	while wait() do
		pcall(function()
			if _25msShared.AntiStranger then
				for L_222_forvar0, L_223_forvar1 in pairs(game:GetService("Players"):GetChildren()) do
					if L_223_forvar1.Data.Level.Value >= 2601 or L_223_forvar1.Data.Level.Value > 20000 then
						game.Players.LocalPlayer:Kick("Kakah Menu found an Admin!")
						print("|KakahMenu DEBUG| Detected Stranger, Hopping Server...")
						Hop()
					end
				end
			end
	...
	task.spawn(function()
		...
		if setfflag then
			task.spawn(function()
				...
				print("|KakahMenu DEBUG| Anti Ban Loaded in: " .. os.clock() - L_228_)
			end)
		else
			print("|KakahMenu DEBUG| Anti Ban not support this Executor!")
		end
	end)
end)
L_35_.Setting:Line()
...
L_35_.Info:Button("My Discord (Click Copy)", function()
	setclipboard("https://discord.gg/RfGUn8KD")
end)
L_35_.Info:Button("My Youtube (Click Copy)", function()
	setclipboard("https://www.youtube.com/@kakazit")
end)
...
task.delay(2, function()
	if hookfunction and not islclosure(hookfunction) then
		print("|KakahMenu DEBUG| Remove Effects")
...
print("|KakahMenu DEBUG| Done loaded KakahMenu in: " .. os.clock() - L_1_)
