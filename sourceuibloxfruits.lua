...
function Library:CreateWindow(hubname)
    ...
    Discord.MouseButton1Click:Connect(function()
        (setclipboard or toclipboard)("https://discord.gg/RfGUn8KD")
        wait(.1)
    ...
    toggle_Image.Image = "http://www.roblox.com/asset/?id=17151909299"
    ...
    function Tabs:addTab(title_tab)
        ...
        function Section:addSection()
            ...
            SectionScroll.ScrollBarImageColor3 = Color3.fromRGB(0, 0, 255)
