local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/kkmenuop/2025/refs/heads/main/sourceuibloxfruits.lua"))() -- LIBRARY

local Window = Library:CreateWindow('KAKAHMENU') -- CREATE WINDOW
...
Changelog:addChangelog('[Dezembro, 25 2024]')
