...
Sound:Play();
local args1 = {[1] = "RolePlayName", [2] = "Gui KakahMenu"};
...
local args4 = {[1] = "RolePlayBio", [2] = "Kakah Menu"};
game:GetService("ReplicatedStorage").RE:FindFirstChild(
...
CRD:AddLabel("Dev - Script: KakahMenu Team");
local function copyText()
    local textToCopy = "https://discord.gg/Z4qauU7D2g";
